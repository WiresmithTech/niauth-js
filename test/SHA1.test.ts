...
describe('SHA1', function() {
   it('should handle arrays of bytes', async function() {
      var message = new Uint8Array([ 0x61, 0x62, 0x63 ]);
      assert.equal("a9993e364706816aba3e25717850c26c9cd0d89d", await sha1(message));
   });
   ...
   it('should handle negative values', async function() {
      var test1a = new Uint8Array([ 0, 0, 0, 0, 0xFF ]);
      var test1b = new Uint8Array([ 0, 0, 0, 0, -1 ]);
      var test2a = new Uint8Array([ 0, 0, 0, 0xFF, 0 ]);
      var test2b = new Uint8Array([ 0, 0, 0, -1, 0 ]);
      var test3a = new Uint8Array([ 0, 0, 0xFF, 0, 0 ]);
      var test3b = new Uint8Array([ 0, 0, -1, 0, 0 ]);
      var test4a = new Uint8Array([ 0, 0xFF, 0, 0, 0 ]);
      var test4b = new Uint8Array([ 0, -1, 0, 0, 0 ]);
      var test5a = new Uint8Array([ 0xFF, 0, 0, 0, 0 ]);
      var test5b = new Uint8Array([ -1, 0, 0, 0, 0 ]);
